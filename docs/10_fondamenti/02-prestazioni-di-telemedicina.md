...
```mermaid
flowchart LR
    subgraph Lato professionista
        M[Medico<br/>obbligatorio, atto riservato]
    end
    subgraph Lato paziente
        P[Paziente<br/>obbligatorio, presente in tempo reale]
        C[Caregiver<br/>facoltativo]
        O[Operatore sanitario<br/>presso il paziente<br/>facoltativo]
    end
    M <-->|sincrono, video| P
    C -.assiste.-> P
    O -.assiste il medico<br/>e o aiuta il paziente.-> P
...
flowchart TB
    ...
    IRT2 <--> NIT
    IRT1 -->|servizi abilitanti,<br/>terminologie, workflow| INT
    IRT1 -->|dati e documenti,<br/>conferiti dalla struttura| FSE
    FSE --> EDS
