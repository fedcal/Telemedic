...
| **Triage** | S | Processo di assegnazione della priorità temporale di valutazione in base al rischio di deterioramento nell'attesa. In Italia è articolato su cinque livelli `[NV]` va verificato in `FUNZ` | [F10](10-percorsi-di-cura-e-sicurezza.md) |
