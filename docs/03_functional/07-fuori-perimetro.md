...
| **OUT-20** | Il progetto non appone marcatura di conformità, non costituisce un soggetto fabbricante, non ingaggia organismi di valutazione e non conduce la valutazione clinica | `RESP` | produce e pubblica il pacchetto regolatorio come materiale per chi certifica; chi immette sul mercato assume il ruolo di fabbricante | dichiarazione pubblicata e verificata in ogni artefatto distribuito |
