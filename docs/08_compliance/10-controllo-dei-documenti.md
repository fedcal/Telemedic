...
>
> **Questo capitolo è una procedura?** No. È la definizione della procedura stessa, la documentazione di come si applica e il perimetro di ciò che si applica a - contenuto nel presente repository. Le procedure operative del sistema di gestione della qualità, quando verranno redatte dal soggetto fabbricante, saranno documenti controllati da questa procedura e risiederanno nel proprio sistema documentale, a norma di ISO 13485 §4.2.4. Finché il soggetto non esiste, questa documentazione è un ingresso per la sua creazione, e non è essa stessa sottoposta ai controlli che descrive (`V-174`).
