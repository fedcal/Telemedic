...
### B-4 — Registro unico della fiducia verso gli integratori

**Non deciso**: se il registro delle configurazioni di fiducia verso un integratore — emittente
ammesso, indirizzo delle chiavi pubbliche, algoritmi, destinatario atteso, mappatura dei claim,
origini ammesse per l'incorporamento, origini ammesse per la condivisione fra origini,
destinazioni ammesse per i messaggi in uscita — sia **uno solo** o siano più registri separati.

**Chi decide**: area di integrazione, con area di sicurezza.

**Posizione di quest'area**: **uno solo**. Tre registri separati divergono sempre, e la divergenza
si manifesta come una configurazione che consente un'operazione e ne vieta un'altra
apparentemente equivalente. Il registro unico è per tenant ed è la sola fonte di verità sulla
fiducia.

**Se non viene presa**: la divergenza si manifesterà con il secondo integratore.
...
| B-4 | Registro unico della fiducia | B | INTEG, SEC | Prima del secondo integratore |
