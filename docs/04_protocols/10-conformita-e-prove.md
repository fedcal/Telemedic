...
| «Prodotto marcato» | Il progetto non appone marcatura né sottoscrive dichiarazioni di conformità: vincolo [V-06](../11_registri/01-vincoli-in-vigore.md#v-06). Non il progetto oggi; il soggetto fabbricante, da costituire |
| «Accreditato» sui canali d'identità nazionali | Il fornitore di servizi è **chi installa**: vincolo [V-05](../11_registri/01-vincoli-in-vigore.md#v-05). Il progetto è conforme e verificabile |
...
> **Strumenti concreti** `[NV]` da fissare dall'`TECH`: i nomi, le versioni e le modalità di
> invocazione degli strumenti di validazione clinica, di pubblicazione delle guide, di analisi statica del
...
> **Da chiedere a**: `TECH`, che ha in carico la catena di costruzione. La scelta va poi
...
- **la tracciabilità è parte del prodotto della catena**: ogni obbligo di specifica coperto è
  ...
  requisito di tracciabilità che rende il materiale utilizzabile nel nostro percorso di valutazione della conformità, ai sensi del vincolo [V-06](../11_registri/01-vincoli-in-vigore.md#v-06).
...
| Template, codici documentali e metadati per le tipologie della telemedicina | [03 §4.2](./03-documenti-clinici.md), [03 §5](./03-documenti-clinici.md) | Area di conformità - questione **[Q-07](../11_registri/02-questioni-aperte.md#q-07)** |
...
| Copertura campo per campo fra set informativo normativo e profilo clinico | [03 §4.1](./03-documenti-clinici.md) | Area di dominio e `COMP` |
...
| Inoltro del livello richiesto attraverso il realm di intermediazione | [08 §6.4](./08-identita-e-autorizzazione.md) | Area di architettura e `TECH` - questione **[Q-160](../11_registri/02-questioni-aperte.md#q-160)** |
...
**[Q-06](../11_registri/02-questioni-aperte.md#q-06) - divergenza dell'URI del codice fiscale.** Quest'area documenta il problema, ne misura le
...
**[Q-15](../11_registri/02-questioni-aperte.md#q-15) - le dieci scelte enunciate come proposta.** Quest'area le formula, le motiva e ne dichiara
...
**[Q-08](../11_registri/02-questioni-aperte.md#q-08) - le due modalità della sessione.** Quest'area descrive il protocollo che le governa in
...
**[Q-16](../11_registri/02-questioni-aperte.md#q-16), [Q-161](../11_registri/02-questioni-aperte.md#q-161) - il registro unico delle destinazioni e delle origini fidate, e il punto unico di
...
**[Q-163](../11_registri/02-questioni-aperte.md#q-163) - nessuna capacità di divulgazione verso un pagatore.** Quest'area la recepisce come
...
e importo. La conferma funzionale spetta all'`FUNZ`.
