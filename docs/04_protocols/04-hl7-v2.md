...
> cablato.
>
> Questo punto è collegato alla questione **[Q-06](../11_registri/02-questioni-aperte.md#q-06)** ma **non coincide con essa**: qui si tratta
> del codice di tipo dentro un segmento v2, là dell'URI del sistema in una risorsa FHIR. La
> decisione su [Q-06](../11_registri/02-questioni-aperte.md#q-06) non risolve automaticamente questa, e viceversa.
...
> **Lettura diretta della specifica del protocollo di incapsulamento** `[NV]` da chiedere a HL7 Int'l.
> I valori esadecimali sopra riportati sono corroborati da fonti che citano la specifica, ma **la lettura
...
> **Lunghezze, obbligatorietà e ripetibilità dei campi del segmento di errore** `[NV]` da chiedere a
> HL7 Int'l. Tre estrazioni indipendenti della stessa fonte hanno prodotto valori mutuamente incompatibili per
...
strutturata del campo mancante. È il vincolo [V-09](../11_registri/01-vincoli-in-vigore.md#v-09) applicato a questo canale: l'assenza di dato è
