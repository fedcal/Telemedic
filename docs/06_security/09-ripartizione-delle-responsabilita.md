...
| `PR.PS-04` | Generazione e conservazione dei registri | I+E | **P** | **Registro a sola aggiunta con catena di hash e conservazione separata**, esportazione in formato aperto con impronta, 24 e 12 mesi ([04](./04-tracciamento.md)) |
