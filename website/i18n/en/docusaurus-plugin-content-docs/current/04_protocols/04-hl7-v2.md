...
>
> This point is connected to question **Q-06** but **does not coincide with it**: here the matter is
> the type code inside a v2 segment, there it is the system URI in a FHIR resource. The decision on
> Q-06 does not automatically resolve this one, and vice versa.
...
location of the missing field. It is constraint V-09 applied to this channel: the absence of a datum
