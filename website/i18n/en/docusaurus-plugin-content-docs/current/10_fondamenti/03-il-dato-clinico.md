...
| Reports and diagnostic documentation | Multi-year terms, differentiated by type | The terms remain to be verified by the `GUIDA` `[NV]` area - not ascertained in the sources consulted |
